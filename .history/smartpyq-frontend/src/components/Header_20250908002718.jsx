...
const Header = () => {
  ...
  const publicNavigation = [
    ...
    { name: 'Browsre Papers', href: '/browse', icon: MagnifyingGlassIcon },
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden">
              <motion.button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-brand-500"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                aria-expanded="false"
              >
                ...
                <div className="border-t border-gray-200 pt-4 pb-3">
                  {isAuthenticated && user ? (
                    <div className="space-y-3">
                      ...
                      <Link
                        to="/dashboard"
                        className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors duration-200"
                      ...
                      <button
                        ...
                        className="block w-full text-left px-3 py-2 text-base font-medium text-red-600 hover:text-red-700 hover:bg-red-50 transition-colors duration-200"
                      >
                        Logout
                      </button>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      <Link
                        to="/login"
                        className="flex-1 text-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-brand-600 hover:bg-brand-50 transition-colors duration-200"
                        onClick={() => setIsMenuOpen(false)}
                      >
                        Login
                      </Link>
                      <Link
                        to="/register"
                        className="flex-1 bg-gradient-to-r from-brand-600 to-accent-600 hover:from-brand-700 hover:to-accent-700 text-white px-3 py-2 rounded-xl text-base font-medium text-center transition-all shadow-lg"
                        onClick={() => setIsMenuOpen(false)}
                      >
                        Sign Up 🚀
                      </Link>
