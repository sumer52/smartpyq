    ...
    bsc: {
      ...
      specializations: {
        mscs: {
          ...
          displayName: 'MSCS',
          subjects: {
            sem1: ['Environmental Studies', 'English', 'Second Language', 'Calculus', 'Statistics', 'Programming C/C++'],
            sem2: ['Environmental Studies', 'English', 'Second Language', 'Linear Algebra', 'Statistics', 'Programming C/C++'],
