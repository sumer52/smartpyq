          ...
          <div className="text-center">
            ...
            >
              <button
                ...
                className="rainbow-gradient text-white font-semibold py-3 px-8 rounded-full bounce-glow flex items-center justify-center space-x-2"
              >
              ...
              <button
                ...
                className="bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-semibold py-3 px-8 rounded-full pulse-rainbow flex items-center justify-center space-x-2"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 h-full relative overflow-hidden floating">
                    {/* Locked Overlay */}
                    {feature.locked && (
                    ...
                    <div className={`w-12 h-12 rainbow-gradient rounded-xl flex items-center justify-center mb-4 bounce-glow`}>
                      <Icon className="w-6 h-6 text-white" />
                    </div>
                    
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 color-shift">
                      {feature.title}
                    </h3>
