...
const FAQPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Click the "Sign Up" button in the top navigation, fill in your details including name, email, and password. You\'ll receive a verification email to activate your account. You can also try our demo account with email: sson@demo.com and password: demo123.'
    },
    {
      id: 4,
      category: 'account',
    ...
    },
    {
      ...
      answer: 'Basic AI assistant features are free for all registered users. Premium features like detailed explanations, personalized study plans, and unlimited queries are available with our paid plans.'
    },
    {
      id: 10,
      category: 'billing',
      question: 'What are the pricing plans?',
      answer: 'We offer a free tier with basic features, and premium plans starting at ₹99/month with unlimited downloads, advanced AI features, and priority support. Student discounts are available with valid ID verification.'
    },
    {
      id: 11,
      category: 'billing',
    ...
    },
    {
      ...
      answer: 'We support papers from major Indian universities including Osmania University, Mumbai University, Bangalore University, and many others. Our collection covers Engineering, Medical, Commerce, Arts, and Science courses.'
    },
    {
      id: 15,
      category: 'papers',
