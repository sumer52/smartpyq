...
async def chat(request: ChatRequest):
    ...
    if not response_text:
        if "python" in message_lower:
            ...
            response_text = f"Thanks for your question about '{request.message}'. I'm currently running in demo mode, but I can help with basic questions about programming, academics, and study materials. Try asking about Python, or type 'help' for more options."
