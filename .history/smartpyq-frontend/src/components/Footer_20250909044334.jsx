        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-1">
            ...
            <div className="mt-6 space-y-2 text-sm text-gray-400">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+9" className="hover:text-white transition-colors">
                  +91 00000 00000
                </a>
              </div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <EnvelopeIcon className="h-5 w-5 mr-3 text-brand-400" />
                <a href="mailto:smartpyq@gmail.com" className="text-gray-300 hover:text-white transition-colors">
                  smartpyq@gmail.com
                </a>
              </div>
              <div className="flex items-center">
                <ChatBubbleLeftRightIcon className="h-5 w-5 mr-3 text-brand-400" />
                <span className="text-gray-300">AI Chat Support Available 24/7</span>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-2 text-sm text-gray-400">
              <div className="flex items-center">
                ...
                <span>Free access to previous year papers</span>
              </div>
              <div className="flex items-center">
                <CheckCircleIcon className="h-4 w-4 mr-2 text-green-400" />
