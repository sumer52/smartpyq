...
const HomePage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Statistics Section */}
      <motion.section 
        className="py-16 bg-gradient-to-r from-brand-600 to-accent-600"
        variants={sectionVariants}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Join thousands of students who have improved their exam performance with SmartPYQ
            </p>
          </motion.div>
          ...
          >
            {[
              { label: 'Question Papers', value: stats.totalPapers.toLocaleString(), icon: '📚' },
              { label: 'Downloads', value: stats.totalDownloads.toLocaleString(), icon: '⬇️' },
              { label: 'Active Students', value: stats.activeUsers.toLocaleString(), icon: '👥' },
              { label: 'Universities', value: stats.universities.toLocaleString(), icon: '🏛️' }
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
                ...
                transition={{ duration: 0.5 }}
              >
                <div className="text-4xl mb-2" role="img" aria-label={stat.label.toLowerCase()}>
                  {stat.icon}
                </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p 
            ...
            transition={{ duration: 0.6, delay: 0.1 }}
          >
            Start exploring our vast collection of previous year question papers and get the edge you need for exam success.
          </motion.p>
          <motion.div 
          ...
          >
            ...
            <motion.a
              href="/upload"
              className="inline-flex items-center px-8 py-4 border-2 border-brand-600 text-brand-600 font-semibold rounded-xl hover:bg-brand-50 focus:outline-none focus:ring-4 focus:ring-brand-500/30 transition-all"
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
            >
              <span role="img" aria-label="upload" className="mr-2">📤</span>
              Upload Paper
            </motion.a>
          </motion.div>
        </div>
