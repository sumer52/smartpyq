        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-brand-400 mb-2">Subscription Plans</h3>
                <p className="text-gray-300 leading-relaxed">
                  We offer both free and paid subscription plans. Paid plans provide additional features and benefits as described on our pricing page.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-brand-400 mb-2">Billing and Refunds</h3>
                <p className="text-gray-300 leading-relaxed">
                  Subscription fees are billed in advance on a monthly or annual basis. Refunds are provided in accordance with our refund policy, typically within 7 days of purchase for unused services.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-brand-400 mb-2">Cancellation</h3>
                <p className="text-gray-300 leading-relaxed">
