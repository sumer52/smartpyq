...
from .routers import (
    # auth_router,  # Temporarily disabled
    # papers_router,  # Temporarily disabled
    # chat_router,  # Temporarily disabled
    # features_router,  # Temporarily disabled
    # admin_router,  # Temporarily disabled
    newsletter_router,
)
# from .routers.metrics import router as metrics_router  # Temporarily disabled
