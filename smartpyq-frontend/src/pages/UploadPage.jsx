          ...
          >
            ...
            <div className="bg-gradient-to-r from-brand-600 to-accent-600 rounded-xl p-6 text-white">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center">
                  <span role="img" aria-label="premium" className="mr-2">💎</span>
                  <span>Get premium features access</span>
                </div>
              </div>
              <motion.button
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                answer: "Yes! You earn points for each approved upload and can unlock contributor badges and premium features."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
