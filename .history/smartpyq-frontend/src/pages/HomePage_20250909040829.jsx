    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-40 h-40 bg-indigo-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse" />
          <div className="absolute bottom-20 right-20 w-32 h-32 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Navigate through years, semesters, and streams with our intelligent card-based system. 
              Find exactly what you need with smooth animations and intuitive filtering.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Multi-Level Navigation</h3>
                    <p className="text-gray-600">Drill down through Years → Semesters → Exam Years → Streams → Subjects with intuitive card interfaces.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Smooth Animations</h3>
                    <p className="text-gray-600">Enjoy fluid transitions and hover effects that make navigation delightful and engaging.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Smart Search & Filter</h3>
                    <p className="text-gray-600">Advanced filtering by subject, year, and stream with real-time search capabilities.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">All Streams Covered</h3>
                    <p className="text-gray-600">B.Sc (MSCS, MSDS, Life Sciences), B.Com, BBA, BCA with comprehensive subject coverage.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                <div className="mb-8">
                  <div className="w-20 h-20 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto lg:mx-0 mb-6">
                    <span className="text-white text-3xl">🧭</span>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Navigate?</h3>
                  <p className="text-gray-600 mb-8">
                    Experience the most intuitive way to find your PYQ papers. 
                    Start with your academic year and let our navigator guide you to the perfect study material.
                  </p>
                </div>
                
                <motion.a
                  href="/pyq"
                  className="group relative inline-flex items-center justify-center w-full px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl text-lg shadow-lg overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            Access comprehensive study materials, AI-powered insights, and complete exam preparation tools - all completely free.
          </motion.p>
