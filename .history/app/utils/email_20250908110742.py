...
class EmailService:
    ...
    def __init__(self):
        ...
        # self._create_default_templates(template_dir)  # Commented out to fix template method issues
...
# email_service = EmailService()  # Commented out to fix circular instantiation issue
