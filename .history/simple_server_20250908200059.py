...
if api_key and api_key not in ["your_gemini_api_key", "your_gemini_api_key_here"] and len(api_key) > 20:
    try:
    ...
    logger.warning("❌ Gemini API: Not configured - using actual API key from Google AI Studio")
